...
export default async function handler(req, res) {
  if (req.method === "GET") {
    try {
      ...
      // دوێنێ: کارمەندی چالاک بێ ئامادەبوون و بێ مۆڵەت → Absent (تەنها رۆژی کار، نە جەژن)
      await data.query(`
      ...
      // ئەمڕۆ: دوای کاتی 18:00 (کۆتایی کار) — کارمەندی چالاک بێ ئامادەبوون و بێ مۆڵەت → Absent (تەنها رۆژی کار، نە جەژن)
      await data.query(`
        INSERT INTO attendance (employee_name, date, check_in, check_out, status)
